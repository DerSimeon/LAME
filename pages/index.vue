...
<template>
  <div class="h-full w-full">
    <div id="logo-text" class="fixed h-1/8 h-full w-full flex justify-center mt-40 -z-10">
      <h1 class="text-4xl font-bold text-white animate-heartbeat">L A M E</h1>
    </div>
    <div class="h-full w-full flex flex-col items-center justify-center">
      <div v-if="!authStore.isLoggedIn"
           class="h-1/8 w-1/8 border rounded-xl shadow-xl shadow-gray-700 bg-white flex justify-center items-center cursor-pointer hover:scale-110 transition-all duration-500 ease-in-out">
        <svg class="rounded-xl cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="215" height="41"
             viewBox="0 0 215 41" @click.prevent="signIn">
